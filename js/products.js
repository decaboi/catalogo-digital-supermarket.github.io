...
// Alternar carrito - Función actualizada
function toggleCart() {
    const cartSidebar = document.getElementById('cart-sidebar');
    const cartOverlay = document.getElementById('cart-overlay');
    ...
    if (cartSidebar) {
        ...
        if (cartToggle) {
            ...
            setTimeout(() => {
                cartToggle.classList.remove('cart-animate');
            }, 300);
        }
    }
}

// Cerrar carrito - Función actualizada
function closeCart() {
    const cartSidebar = document.getElementById('cart-sidebar');
    const cartOverlay = document.getElementById('cart-overlay');
...
// Actualizar contador del carrito - Función actualizada
function updateCartCount() {
